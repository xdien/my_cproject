...
//void input_set_info(char *t, int len, int r, int f, int nch);/*Not used*/
...
static void input_general_file_info_box(char *filename, InputPlugin *ip)
{
	...
	g_signal_connect(GTK_OBJECT(window), "key_press_event", GTK_SIGNAL_FUNC(util_dialog_keypress_cb), NULL);
